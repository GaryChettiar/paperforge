...
const Index = () => {
  ...
  // All code that uses useSidebar now needs to be defined *inside* the provider tree as a child
  return (
    <SidebarProvider>
      <SidebarLayout
...
// Move all sidebar-related UI and hooks here so no useSidebar is outside the Provider
const SidebarLayout = ({
  resumeData,
  setResumeData,
  selectedTemplate,
  ...
  // FAB ONLY when sidebar is collapsed (desktop only)
