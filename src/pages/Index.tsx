...
const Index = () => {
  ...
  return (
    <SidebarProvider>
      {/* Move FABSidebarTrigger INSIDE provider since it must use the context */}
      {/* Declare FABSidebarTrigger as an inner function */}
      {(() => {
        const { state } = useSidebar();
        const isSidebarCollapsed = state === "collapsed";
        // Define the FABSidebarTrigger component here so it can use the hook
        const FABSidebarTrigger = () => (
          <div className="fixed top-24 left-4 z-50 md:block hidden">
            <SidebarTrigger
              className="bg-white border border-gray-300 rounded-full shadow-lg w-14 h-14 flex items-center justify-center transition hover:bg-gray-100"
